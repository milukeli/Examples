...
with open('AIS-commands') as f:
    ...
    for Acommand in commands:
        ...
        if devtype == "cisco_ios":
            cisco_ios_commands_list.append(hostname)
        elif devtype == "cisco_nxos":
            cisco_nxos_commands_list.append(hostname)
        elif devtype == "cisco_asa":
            cisco_asa_commands_list.append(hostname)
        elif devtype == "cisco_wlc":
            cisco_wlc_commands_list.append(hostname)
        elif devtype == "huawei":
            huawei_commands_list.append(hostname)
        elif devtype == "huawei_vrpv8_list":
            huawei_vrpv8_commands_list.append(hostname)
        elif devtype == "alcatel_sros":
            alcatel_sros_commands_list.append(hostname)
        elif devtype == "checkpoint_gaia":
            checkpoint_gaia_commands_list.append(hostname)
        elif devtype == "fortinet":
            fortinet_commands_list.append(hostname)
        elif devtype == "juniper":
            juniper_commands_list.append(hostname)
        elif devtype == "juniper_junos":
            juniper_junos_commands_list.append(hostname)
        elif devtype == "nokia_sros":
            nokia_sros_commands_list.append(hostname)
        elif devtype == "zte_zxros":
            zte_zxros_commands_list.append(hostname)
        else:
            unknown_os_commands_list.append(hostname)
